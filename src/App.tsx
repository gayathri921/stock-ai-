  ...
  useEffect(() => {
    ...
    const fetchNews = async () => {
      ...
      const mockNews = [
        {
          id: 1,
          title: `${symbol} Reports Strong Quarterly Earnings, Beating Analyst Expectations`,
          source: 'MarketWatch',
          date: '2h ago',
          sentiment: 'positive'
        },
        {
          id: 2,
          title: `Why Analysts are Bullish on ${symbol} for the Remainder of 2026`,
          source: 'Bloomberg',
          date: '5h ago',
          sentiment: 'positive'
        },
        {
          id: 3,
          title: `New Product Launch: ${symbol} Unveils Next-Gen AI Integration`,
          source: 'TechCrunch',
          date: '1d ago',
          sentiment: 'neutral'
        },
        {
          id: 4,
          title: `Market Volatility: How ${symbol} is Navigating Global Economic Shifts`,
          source: 'Reuters',
          date: '2d ago',
          sentiment: 'neutral'
        }
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 pb-12">
        ...
        {newsLoading ? (
          ...
          <div className="space-y-3">
            {news.map(article => (
              <div key={article.id} className="bg-[#0A1227] p-4 rounded-2xl border border-white/5 hover:bg-white/5 transition-colors cursor-pointer group">
      ...
      <div className="p-4 bg-[#0A1227]/90 backdrop-blur-xl border-t border-white/5 flex gap-2 items-center pb-[100px] z-40 relative">
        <div className="relative flex-1 flex items-center bg-[#050A18] border border-white/10 rounded-2xl px-2">
          <input 
            ...
            placeholder={isListening ? "Listening..." : "Ask your StockAI buddy..."}
            className="flex-1 bg-transparent border-none py-4 px-2 focus:outline-none text-white placeholder:text-gray-600 text-sm"
          />
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className={cn(
                ...
                isAdded ? "text-emerald-400" : "text-gray-600 hover:text-blue-400"
              )}
            >
